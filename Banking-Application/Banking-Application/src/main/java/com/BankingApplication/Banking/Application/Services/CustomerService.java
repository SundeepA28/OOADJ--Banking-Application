...
public class CustomerService {
    ...
    public boolean createCustomer(String Name,Long PhoneNumber,String Address,String Email,String Username,String Password){
        ...
        Customer cust = new Customer(id,Name,PhoneNumber,Email,Address,Username,Password);
